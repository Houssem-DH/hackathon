...
export default function Home({ auth, question, answers }) {
    ...
    useEffect(() => {
        const socket = new WebSocket("ws://127.0.0.1:3500/ws/predict"); // Replace with your server URL
        socket.onopen = () => {
            ...
            <Layout user={auth.user}>
                <div className="container mx-auto px-6 py-10">
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
                        <h1 className="text-3xl font-bold mb-4 text-gray-900">{question.question_title}</h1>
                    ...
                    <div className="space-y-8">
                        <h2 className="text-xl font-semibold mb-4 text-gray-900">Answers</h2>
